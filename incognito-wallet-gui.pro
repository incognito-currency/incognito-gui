...
WALLET_ROOT=$$PWD/incognito

CONFIG += c++11
QMAKE_CXXFLAGS += -fPIC -fstack-protector
QMAKE_LFLAGS += -fstack-protector

# cleaning "auto-generated" incognito directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently incognito has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/incognito-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/incognito-core_ar.ts \ # Arabic
                $$PWD/translations/incognito-core_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/incognito-core_de.ts \ # German
                $$PWD/translations/incognito-core_eo.ts \ # Esperanto
                $$PWD/translations/incognito-core_es.ts \ # Spanish
                $$PWD/translations/incognito-core_fi.ts \ # Finnish
                $$PWD/translations/incognito-core_fr.ts \ # French
                $$PWD/translations/incognito-core_hr.ts \ # Croatian
                $$PWD/translations/incognito-core_id.ts \ # Indonesian
                $$PWD/translations/incognito-core_hi.ts \ # Hindi
                $$PWD/translations/incognito-core_it.ts \ # Italian
                $$PWD/translations/incognito-core_ja.ts \ # Japanese
                $$PWD/translations/incognito-core_nl.ts \ # Dutch
                $$PWD/translations/incognito-core_pl.ts \ # Polish
                $$PWD/translations/incognito-core_ru.ts \ # Russian
                $$PWD/translations/incognito-core_sv.ts \ # Swedish
                $$PWD/translations/incognito-core_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/incognito-core_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/incognito-core_he.ts \ # Hebrew
                $$PWD/translations/incognito-core_ko.ts \ # Korean
                $$PWD/translations/incognito-core_ro.ts \ # Romanian
                $$PWD/translations/incognito-core_da.ts \ # Danish
                $$PWD/translations/incognito-core_cs.ts \ # Czech
                $$PWD/translations/incognito-core_sk.ts \ # Slovak
                $$PWD/translations/incognito-core_ar.ts \ # Arabic
                $$PWD/translations/incognito-core_sl.ts \ # Slovenian
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libincognito-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    incognito/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = incognito-core.rc
