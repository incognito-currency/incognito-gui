...
- Github: [https://github.com/incognito-currency/incognito-gui](https://github.com/incognito-currency/incognito-gui)
- IRC: [#incognito-dev on Freenode](irc://chat.freenode.net/#incognito-dev)
...
This is the GUI for the [core Incognito implementation](https://github.com/incognito-currency/incognito). It is open source and completely free to use without restrictions, except for those specified in the license agreement below. There are no restrictions on anyone creating an alternative implementation of Incognito that uses the protocol and network in a compatible manner.
...
Incognito is a 100% community-sponsored endeavor. If you want to join our efforts, the easiest thing you can do is support the project financially. Both Incognito and Bitcoin donations can be made to **donate.getincognito.org** if using a client that supports the [OpenAlias](https://openalias.org) standard.
...
## Installing the Incognito GUI from a package

Packages are available for

* Arch Linux via AUR: [incognito-wallet-qt](https://aur.archlinux.org/packages/incognito-wallet-qt/)
* Void Linux: xbps-install -S incognito-core

Packaging for your favorite distribution would be a welcome contribution!

## Compiling the Incognito GUI from source

### On Linux:

(Tested on Ubuntu 16.04 x86, 16.10 x64, Gentoo x64 and Linux Mint 18 "Sarah" - Cinnamon x64)

1. Install Incognito dependencies
...
2. Grab an up-to-date copy of the incognito-gui repository

	`git clone https://github.com/incognito-currency/incognito-gui.git`
...
3. Install [incognito](https://github.com/incognito-currency/incognito) dependencies:
...
6. Grab an up-to-date copy of the incognito-gui repository
...
2. Install Incognito dependencies as described in [incognito documentation](https://github.com/incognito-currency/incognito) into msys2 environment
