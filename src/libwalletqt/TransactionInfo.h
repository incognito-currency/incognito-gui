...
public:
    enum Direction {
        Direction_In  =  Incognito::TransactionInfo::Direction_In,
        Direction_Out =  Incognito::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Incognito::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Incognito::TransactionInfo * m_pimpl;
