...
public:
    enum LogLevel {
        LogLevel_Silent = Incognito::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Incognito::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Incognito::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Incognito::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Incognito::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Incognito::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Incognito::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Incognito::WalletManagerFactory::LogLevel_Max,
    };
...
private:
    ...
    Incognito::WalletManager * m_pimpl;
    QMutex m_mutex;
