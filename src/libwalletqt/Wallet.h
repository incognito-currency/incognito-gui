...
#include "wallet/api/wallet2_api.h" // we need to have an access to the Incognito::Wallet::Status enum here;
...
public:
    ...
    enum Status {
        Status_Ok       = Incognito::Wallet::Status_Ok,
        Status_Error    = Incognito::Wallet::Status_Error,
        Status_Critical = Incognito::Wallet::Status_Critical
    };

    Q_ENUM(Status)

    enum ConnectionStatus {
        ConnectionStatus_Connected       = Incognito::Wallet::ConnectionStatus_Connected,
        ConnectionStatus_Disconnected    = Incognito::Wallet::ConnectionStatus_Disconnected,
        ConnectionStatus_WrongVersion    = Incognito::Wallet::ConnectionStatus_WrongVersion
    };
...
private:
    ...
    Wallet(Incognito::Wallet *w, QObject * parent = 0);
    ~Wallet();
private:
